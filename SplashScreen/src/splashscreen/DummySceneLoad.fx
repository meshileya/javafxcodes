...
def BackgroundImage = ImageView {
    image: Image {url:"{__DIR__}Bliss.jpg"};
}
...
var Internet:ImageView = ImageView {
    ...
    onMouseExited: function(e: MouseEvent): Void {
        scaleTransition.stop();
        Internet.image = Image {url:"{__DIR__}internet.png"};
        Internet.scaleX = .18;
        Internet.scaleY = .18;
    }
}
...
var dockbackground:ImageView = ImageView {
    ...
    scaleY: .75
    opacity: .4;
    image: Image {url:"{__DIR__}DockBackgroundSolid.png"}
}
...
public var DummyScene:Scene = Scene {
        width: 700
        height: 700
        content: [
            BackgroundImage,
...
public function constructDock() : Void {
    insert hbox into DummyScene.content;
    trans.playFromStart();
}
